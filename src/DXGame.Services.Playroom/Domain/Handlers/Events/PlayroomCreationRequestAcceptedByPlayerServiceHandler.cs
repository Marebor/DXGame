...
{
    public class PlayroomCreationRequestAcceptedByPlayerServiceHandler : IEventHandler<PlayroomCreationRequestAccepted>
    {
        private readonly IEventService _eventService;
        private readonly IHandler _handler;

        public PlayroomCreationRequestAcceptedByPlayerServiceHandler(IEventService eventService, IHandler handler)
        {
            _eventService = eventService;
            _handler = handler;
        }

        public async Task HandleAsync(PlayroomCreationRequestAccepted e) => await _handler
            .LoadAggregate(async () =>
            {
            ...
            .Run(async aggregate =>
            {
                aggregate.OnPlayroomCreationRequestAcceptedByPlayerService(e);
