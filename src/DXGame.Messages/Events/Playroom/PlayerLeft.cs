...
{
    public class PlayerLeft : ICommandRelatedEvent, IAggregateAppliedEvent
    {
        public PlayerLeft(Guid playroom, Guid player, int appliedOnAggregateVersion, Guid relatedCommand)
        {
